...
df = (wau
      .merge(opac[["week_start","orders_net","revenue_net","opac"]], on="week_start", how="outer")
      .merge(aov[["week_start","aov"]], on="week_start", how="outer")
      .merge(rpw[["week_start","revenue_net","rev_per_wau"]]
               .rename(columns={"revenue_net":"revenue_net_check"}), on="week_start", how="outer")
...
out_cols = ["week_start","wau","orders_net","revenue_net","aov","opac","rev_per_wau","refund_rate"]
out = df[out_cols]
