...
py_df = pd.read_csv(INTERIM / "rev_per_wau.csv", parse_dates=["week_start"]).sort_values("week_start")
...
print("\nParity vs pandas:")
cols = ["week_start","wau_py","wau_sql","revenue_net_py","revenue_net_sql",
        "rev_per_wau_py","rev_per_wau_sql","wau_match","revenue_match","rpw_match"]
